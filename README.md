...
**当你在受限页面尝试使用扩展时，会看到友好的通知消息说明原因。**

这是浏览器的安全限制，所有扩展都受此约束，无法绕过。扩展在所有普通 HTTP/HTTPS 网页上都可以正常工作。

详细说明请查看 [RESTRICTED_PAGES_FIX.md](RESTRICTED_PAGES_FIX.md)。
